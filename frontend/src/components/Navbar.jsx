...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="hidden md:flex fixed left-0 top-0 h-screen w-60 bg-white border-r border-gray-200 shadow-sm flex-col justify-between">
        <div className="p-6">
          <div
      ...
      <nav className="md:hidden fixed bottom-0 left-0 w-full bg-white border-t border-gray-200 shadow-sm flex justify-around py-2 z-50">
        <button
          onClick={() => navigate("/feed")}
          className="flex flex-col items-center text-gray-600 hover:text-pink-500 text-xs"
        >
          <Home size={20} />
          <span>Feed</span>
        </button>
        ...
        <button
          onClick={logout}
          className="flex flex-col items-center text-gray-600 hover:text-red-500 text-xs"
        >
          <LogOut size={20} />
          <span>Logout</span>
        </button>
